...
public class SecurityConfig {
    ...
    public JWKSource<SecurityContext> jwkSource() {
        ...
        // key will be used to sign JWT thus allowing resource server to create public key
        // public key on resource server is used to authenticate JWT signed private key
    ...
    // An instance of AuthorizationServerSettings to configure Spring Authorization Server (add server settings to
    // spring context for auth server)
    @Bean
